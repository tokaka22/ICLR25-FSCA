...
def build_edges(sequence):
    ...
    edges = np.concatenate([edges_1_to_2])
...
def construct_sequence(L_p, L_fix_prompt, s, L_task_prompt):
    # Constructing the array
    array = np.concatenate([
        np.full(L_p, 1),          # First L_p elements as 1
        np.full(L_task_prompt, 2), # Next L_fix_prompt elements as 2
    ])
