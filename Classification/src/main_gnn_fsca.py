...
from running_fsca import setup, pipeline_factory, validate, check_progress, NEG_METRICS
from utils import utils
from datasets.data_fsca import data_factory, Normalizer
from datasets.datasplit import split_dataset
from models.ts_transformer import model_factory
from models.gpt4ts import gpt4ts
from models.GNNLLM_fsca import GNNLLM_fsca
...
def main(config):
    ...
    model = GNNLLM_fsca(config, my_data)
