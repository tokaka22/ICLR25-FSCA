...
class Options(object):
    ...
    def __init__(self):
        ...
        # Model
        self.parser.add_argument('--model', default="transformer",
                                 help="Model class")
        ...
        ### new params
        self.parser.add_argument('--split_len', type=int, default=2) 
        self.parser.add_argument('--d_l_comp', type=int, default=512)
        self.parser.add_argument('--w_l2s_flag', type=int, default=0)
        self.parser.add_argument('--w_l2s_v', type=float, default=1)
        self.parser.add_argument('--layer_index', type=str, help='A space-separated string of integers')
        self.parser.add_argument('--patch_size_stride', type=str, help='A space-separated string of integers')
        self.parser.add_argument('--revin_flag', type=int, default=0)
        self.parser.add_argument('--enc_in', type=int, default=3)

        self.parser.add_argument('--d_ff', type=int, default=512)
        self.parser.add_argument('--in_dropout', type=float, default=0)
        self.parser.add_argument('--out_dropout', type=float, default=0.1)

        self.parser.add_argument('--wd_project', default='time_llm_test', type=str)
        self.parser.add_argument('--test_flag', type=int, default=0) # iter num
        self.parser.add_argument('--wandb_flag', type=int, default=1) # debug close wandb
        self.parser.add_argument('--patience', type=int, default=20)

        self.parser.add_argument('--is_valid_len', type=int, default=0)
